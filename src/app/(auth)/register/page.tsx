...
const PROGRAMS = [
  ...
  { id: "bsa", label: "BS Accountancy" },
  { id: "beed", label: "BE Elementary Education" },
  { id: "bscrim", label: "BS Criminology" },
] as const;
...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (roleError) {
        setGeneralError("Failed to assign role. Please try again.");
        return;
      }
      ...
      if (form.role === "student") {
        const { error: studentError } = await supabase
          ...
          .insert({
            ...
            year_level_id: form.yearLevel,
            section: form.section,
            verification_status: "pending",
          });

        if (studentError) {
          setGeneralError("Failed to create student profile. Please try again.");
          return;
        }
      } else {
        ...
        if (facultyError) {
          setGeneralError("Failed to create faculty profile. Please try again.");
          return;
        }
      }
